...
def upload_file(file_path):
    try:
        ...
        data = {
            'message': f'Update {file_path} - Database fix',
...
# The specific database-related files we need to upload
files_to_upload = [
    'app.py',  # Contains database connection settings
...
upload_file('upload_db_changes.py')
